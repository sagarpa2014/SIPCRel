...
<div class="borderBottom"><h1>MONITOR GLOBAL DE PAGOS</h1></div><br>
<div id="dialogo_1"></div>
<s:form action="reporteMonitorGlobal" onsubmit="return chkCampoConsultaReportes();">
	...
	<div class="clear"></div>
	<s:if test="lstReporteGlobalV.size() > 0">
		<fieldset class="clear">
		...
		<div class="exporta_csv">
			<label class="label2"> Exportar Datos </label> <a href="<s:url value="/reportes/exportaReporteGlobal"/>" title="Exportar Datos" ></a>
		</div>
		<div class="clear"></div>
		<fieldset>
			<display:table id="r"  name="lstReporteGlobalV" defaultsort="1" decorator="org.displaytag.decorator.TotalTableDecorator" list="lstReporteGlobalV"  pagesize="20" sort="list" requestURI="/reportes/reporteMonitorGlobal"  class="displaytag">
