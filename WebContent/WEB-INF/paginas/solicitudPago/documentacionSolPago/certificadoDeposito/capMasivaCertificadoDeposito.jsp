...
<div class="clear"></div>
<s:form action="registraArchivoCertificadoDeposito" onsubmit="return chkArchivoCertificadoDeposito();" method="post" enctype="multipart/form-data">
<s:hidden id="folioCartaAdhesion" name="folioCartaAdhesion" value="%{folioCartaAdhesion}"/>
	<div>
		<label class="left1"><span class="norequerido">*</span>Cargar Certificados a la Base de Datos:</label>
