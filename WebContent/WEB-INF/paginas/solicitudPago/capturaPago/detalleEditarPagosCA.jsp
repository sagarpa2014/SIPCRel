			     ...
			     success: function(data) {
			    	var $response=$(data);
			    	 ...
			    	 if(errorSistema != 0){//si hubo error
			    		 ...
			    		 $('#detalleEditarPagosCartaAdhesion').html(data).ready(function () {		    		
								$("#img-espera").fadeOut("slow", function() {
							   		  $("#espera").fadeOut("slow");
							   	});  
					    	}); 
...
<div id="detalleEditarPagosCartaAdhesion">
		<s:include value="/WEB-INF/paginas/solicitudPago/capturaPago/detalleEditarPagosCartaAdhesion.jsp"/>
</div>
