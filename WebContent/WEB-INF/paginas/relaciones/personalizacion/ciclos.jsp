		...
		<table class="clean">
			...
			<s:iterator value="lstCiclosProgramas" var="resultado"  status="itStatus">
				<tr>
					...
					<td>
						<s:select id="a%{#itStatus.count}" name="selecAnio" list="lstEjercicios" listKey="ejercicio" listValue="%{ejercicio}" headerKey="-1" headerValue="-- Seleccione una opción --"  value="%{idEjercicio}" cssClass="anioClass" />
					</td>					
				</tr>	
			</s:iterator>
		</table>
