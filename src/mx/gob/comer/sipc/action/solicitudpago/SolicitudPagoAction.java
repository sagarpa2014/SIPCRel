...
public class SolicitudPagoAction extends ActionSupport implements SessionAware{
	...
	public String capSolicitudPago(){
		try{
	...
	public String registraSolicitudPago(){
		try{			
			documento = spDAO.consultaExpedientesSPCartaAdhesion(idExpSPCartaAdhesion).get(0);
			...
			nombreArchivo = 3+new java.text.SimpleDateFormat("yyyyMMddHHmm").format(new Date())+ext; //Archivo de Expediente
