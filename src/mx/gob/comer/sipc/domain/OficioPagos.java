...
@Entity
@Table(name = "oficio_pagos")
public class OficioPagos {
	...
	@Id
	@GeneratedValue(generator = "oficio_pagos_id_oficio_pagos_seq")
	@SequenceGenerator(name = "oficio_pagos_id_oficio_pagos_seq", sequenceName = "oficio_pagos_id_oficio_pagos_seq")
